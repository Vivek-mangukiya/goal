...
<div class="sub-header">
    <div class="container">
        <div class="sub-header-box">
            <ul>
                <li>
                    <img src="{{ asset('storage/app/public/frontassests/images/contact.svg') }}" alt="">
                    <a href="tel:{{contact()}}">{{contact()}}</a>
                </li>
                <li>
                    <img src="{{ asset('storage/app/public/frontassests/images/header-email.svg') }}" alt="">
            ...
            <div class="collapse justify-content-center navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle @yield('services')" href="{{route('services.detailedMEPdesign')}}" id="navbarDropdownMenuLink"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Services <img src="{{ asset('storage/app/public/frontassests/images/drop-arrow.svg') }}"
                                alt="">
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href="javascript:void(0)">On Demand MEP Services</a>
                        </div>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="http://example.com" id="navbarDropdownMenuLink"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Our Company <img src="{{ asset('storage/app/public/frontassests/images/drop-arrow.svg') }}"
                                alt="">
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
